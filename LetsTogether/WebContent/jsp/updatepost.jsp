...
<div class="container">
  ...
  <form id="signupForm" class="form-signin" action="${contextPath}/updatepost.do">
    <h2 class="form-signin-heading">Please Update Posting</h2>

	<label for="inputTitle" class="sr-only">Title</label>
    <input type="text" name="title" id="inputTitle" class="form-control" placeholder="Title - 글자 수 50자 제한" 
    value="${param.title}" maxlength=50>
    ...
    value="${param.post}" maxlength=150>
